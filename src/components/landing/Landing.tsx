      ...
      >
        ...
        <div className="relative z-20 mx-auto max-w-3xl px-5 pb-16 pt-28 text-center">
          ...
          <p className="nrld-hero-in mx-auto mt-5 max-w-xl text-[0.95rem] font-semibold leading-relaxed text-white/70 sm:text-base" style={{ animationDelay: "0.5s" }}>
            Two feeds, one rabbit hole: an endless stream of synthetic cinema to
            just watch — and blind raffles where every clip is either REAL footage
            or a machine dream. Call it, put $1–5 on the seam — the bank resolves
            in under a minute.
          </p>
        ...
        <div className="nrld-marquee-track">
          {[0, 1].map((copy) => (
            <div key={copy} className="flex shrink-0 items-center">
              {["real or synth", "bet the seam", "the bank never sleeps", "47+ curated clips", "watch what shouldn’t exist", "the verdict drops in under a minute", "bring an eye — keep 20%"].map((w) => (
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-2">
            <Reveal delay={80}>
              <p className="text-[1rem] font-semibold leading-relaxed text-white/75">
                no reality. is a curation project for AI-generated video: a living
                stream of clips discovered across Threads and Instagram, credited to
                their authors and ranked by real human attention. It runs on two
                feeds — the first is pure watching, an endless channel of what the
                machines are dreaming up right now; the second is the court, where
                the same clips come back with their nature hidden and the bank open.
              </p>
              <p className="mt-5 text-[1rem] font-semibold leading-relaxed text-white/75">
                We are not a generation tool. A decentralized crew of crows watches
                the machine output around the clock so you don’t have to: only the
                clips that make you stop scrolling make it in. Watch for pleasure —
                or put your eye where your money is and split the pool when the
                verdict lands.
              </p>
            </Reveal>
            ...
            {[
              {
                ...
                text: "The feed: full-screen clips, one swipe at a time — 15 to 60 seconds each, ~70% synthesized, ~30% terrifyingly real. No account, no paywall, just watch.",
              },
              {
                step: "02 — call it",
                title: "REAL or SYNTH",
                text: "The raffles: the same clips, stripped of titles and authors. Trust your eye — real footage or a machine dream? Two feeds, so the guess never has to end.",
              },
              {
                step: "03 — bet",
                title: "Put $1–5 on it",
        ...
        <div className="mx-auto max-w-5xl px-5">
          <Reveal>
            ...
            <h2 className="mt-3 text-center text-[2rem] font-extrabold leading-tight tracking-tight text-white sm:text-[2.6rem]">
              Every card has <span className="nrld-blood-text">two faces</span>.
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-center text-[0.95rem] font-semibold leading-relaxed text-white/65">
              Four jokers run the floor — and every card in the house deck has two
              faces: REAL on one side, SYNTH on the other. Pick the wrong face and
              the bank keeps your coin.
            </p>
          </Reveal>

          <div className="nrld-fan-scene mt-14 flex items-end justify-center">
            {[
              { label: "REAL", accent: "#D9A441", rot: "-20deg", ty: "10px", tz: "0px" },
              { label: "SYNTH", accent: "#FF003C", rot: "-7deg", ty: "-6px", tz: "40px" },
              { label: "THE SEAM", accent: "#7B2CBF", rot: "7deg", ty: "-6px", tz: "40px" },
              { label: "NO REALITY", accent: "#00F0FF", rot: "20deg", ty: "10px", tz: "0px" },
            ].map((c, i) => (
          ...
          <div className="grid gap-10 sm:grid-cols-3">
            ...
            <div>
              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <a href="/bet" className="text-[0.82rem] font-bold text-white/65 transition-colors hover:text-white">
                  the raffles →
                </a>
